...
int f2fs_write_inline_data(struct inode *inode, struct page *page)
{
...
#ifdef penta
	trace_printk("[penta]start in f2fs_write_inline_data \n");
#endif
	...
	f2fs_put_dnode(&dn);
#ifdef penta
	trace_printk("[penta]end in f2fs_write_inline_data\n");
#endif
	return 0;
}
...
#ifdef penta
	trace_printk("[penta]inline_data_fiemap : %lu", ni.blk_addr);
#endif
